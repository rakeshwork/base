...
CREATE TABLE `pages` (
  ...
  KEY `fk_pages_page_statuses1_idx` (`status`),
  CONSTRAINT `fk_pages_page_statuses1` FOREIGN KEY (`status`) REFERENCES `page_statuses` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
